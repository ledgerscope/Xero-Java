...
import com.xero.models.file.FileResponse204;
...
public class FilesApi {
    ...
    **/
    public Association  createFileAssociation(String accessToken, String xeroTenantId, UUID fileId, Association association) throws IOException {
        try {
            ...
            HttpResponse response = createFileAssociationForHttpResponse(accessToken, xeroTenantId, fileId, association);
    ...
    public HttpResponse createFileAssociationForHttpResponse(String accessToken,  String xeroTenantId,  UUID fileId,  Association association) throws IOException {
    ...
    **/
    public Folder  createFolder(String accessToken, String xeroTenantId, Folder folder) throws IOException {
        try {
            ...
            HttpResponse response = createFolderForHttpResponse(accessToken, xeroTenantId, folder);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    public HttpResponse createFolderForHttpResponse(String accessToken,  String xeroTenantId,  Folder folder) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public FileResponse204  deleteFile(String accessToken, String xeroTenantId, UUID fileId) throws IOException {
        try {
            TypeReference<FileResponse204> typeRef = new TypeReference<FileResponse204>() {};
            HttpResponse response = deleteFileForHttpResponse(accessToken, xeroTenantId, fileId);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public FileResponse204  deleteFileAssociation(String accessToken, String xeroTenantId, UUID fileId, UUID objectId) throws IOException {
        try {
            TypeReference<FileResponse204> typeRef = new TypeReference<FileResponse204>() {};
            HttpResponse response = deleteFileAssociationForHttpResponse(accessToken, xeroTenantId, fileId, objectId);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public FileResponse204  deleteFolder(String accessToken, String xeroTenantId, UUID folderId) throws IOException {
        try {
            TypeReference<FileResponse204> typeRef = new TypeReference<FileResponse204>() {};
            HttpResponse response = deleteFolderForHttpResponse(accessToken, xeroTenantId, folderId);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    **/
    public List<Association>  getAssociationsByObject(String accessToken, String xeroTenantId, UUID objectId) throws IOException {
        try {
            ...
            HttpResponse response = getAssociationsByObjectForHttpResponse(accessToken, xeroTenantId, objectId);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    public HttpResponse getAssociationsByObjectForHttpResponse(String accessToken,  String xeroTenantId,  UUID objectId) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
  ...
  /**
    ...
    **/
    public FileObject  updateFile(String accessToken, String xeroTenantId, UUID fileId, FileObject fileObject) throws IOException {
        try {
            TypeReference<FileObject> typeRef = new TypeReference<FileObject>() {};
            HttpResponse response = updateFileForHttpResponse(accessToken, xeroTenantId, fileId, fileObject);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    public HttpResponse updateFileForHttpResponse(String accessToken,  String xeroTenantId,  UUID fileId,  FileObject fileObject) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
  ...
  /**
    ...
    **/
    public Folder  updateFolder(String accessToken, String xeroTenantId, UUID folderId, Folder folder) throws IOException {
        try {
            TypeReference<Folder> typeRef = new TypeReference<Folder>() {};
            HttpResponse response = updateFolderForHttpResponse(accessToken, xeroTenantId, folderId, folder);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    public HttpResponse updateFolderForHttpResponse(String accessToken,  String xeroTenantId,  UUID folderId,  Folder folder) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public FileObject  uploadFile(String accessToken, String xeroTenantId, UUID folderId, File body, String name, String filename, String mimeType) throws IOException {
        try {
            TypeReference<FileObject> typeRef = new TypeReference<FileObject>() {};
            HttpResponse response = uploadFileForHttpResponse(accessToken, xeroTenantId, folderId, body, name, filename, mimeType);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    public HttpResponse uploadFileForHttpResponse(String accessToken,  String xeroTenantId,  UUID folderId,   body,  String name,  String filename,  String mimeType) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {

...
public class FilesApi {
  ...
  public Association createFileAssociation(
      String accessToken, String xeroTenantId, UUID fileId, Association association)
      throws IOException {
    try {
      TypeReference<Association> typeRef = new TypeReference<Association>() {};
      HttpResponse response =
          createFileAssociationForHttpResponse(accessToken, xeroTenantId, fileId, association);
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   */
  public Folder createFolder(String accessToken, String xeroTenantId, Folder folder)
      throws IOException {
    try {
  ...
  public HttpResponse createFolderForHttpResponse(
      String accessToken, String xeroTenantId, Folder folder) throws IOException {
    // verify the required parameter 'xeroTenantId' is set
    if (xeroTenantId == null) {
      throw new IllegalArgumentException(
   ...
   *
   * <p><b>204</b> - A successful request returns 204 empty response - populate with status property
   * in SDK
   *
   * @param xeroTenantId Xero identifier for Tenant
   * @param fileId File id for single object
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   */
  public FileResponse204 deleteFile(String accessToken, String xeroTenantId, UUID fileId)
      throws IOException {
    try {
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   */
  public FileResponse204 deleteFileAssociation(
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   */
  public FileResponse204 deleteFolder(String accessToken, String xeroTenantId, UUID folderId)
      throws IOException {
    try {
      TypeReference<FileResponse204> typeRef = new TypeReference<FileResponse204>() {};
  ...
  public List<Association> getAssociationsByObject(
      String accessToken, String xeroTenantId, UUID objectId) throws IOException {
    try {
      TypeReference<List<Association>> typeRef = new TypeReference<List<Association>>() {};
      HttpResponse response =
          getAssociationsByObjectForHttpResponse(accessToken, xeroTenantId, objectId);
      return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    } catch (HttpResponseException e) {
      if (logger.isDebugEnabled()) {
        logger.debug(
  ...
  public FileObject updateFile(
      String accessToken, String xeroTenantId, UUID fileId, FileObject fileObject)
      throws IOException {
    try {
      TypeReference<FileObject> typeRef = new TypeReference<FileObject>() {};
      HttpResponse response =
          updateFileForHttpResponse(accessToken, xeroTenantId, fileId, fileObject);
      return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    } catch (HttpResponseException e) {
      if (logger.isDebugEnabled()) {
        logger.debug(
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   */
  public Folder updateFolder(String accessToken, String xeroTenantId, UUID folderId, Folder folder)
      throws IOException {
    try {
      TypeReference<Folder> typeRef = new TypeReference<Folder>() {};
      HttpResponse response =
          updateFolderForHttpResponse(accessToken, xeroTenantId, folderId, folder);
      return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    } catch (HttpResponseException e) {
      if (logger.isDebugEnabled()) {
        logger.debug(
  ...
  public HttpResponse updateFolderForHttpResponse(
      String accessToken, String xeroTenantId, UUID folderId, Folder folder) throws IOException {
    // verify the required parameter 'xeroTenantId' is set
    if (xeroTenantId == null) {
      throw new IllegalArgumentException(
